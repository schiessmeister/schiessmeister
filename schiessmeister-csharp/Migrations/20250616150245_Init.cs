        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableClasses = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AnnouncementUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Competitions_Organizations_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecordedCompetitionsId = table.Column<int>(type: "int", nullable: false),
                    RecordersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCompetition", x => new { x.RecordedCompetitionsId, x.RecordersId });
                    table.ForeignKey(
                        name: "FK_AppUserCompetition_AspNetUsers_RecordersId",
                        column: x => x.RecordersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserCompetition_Competitions_RecordedCompetitionsId",
                        column: x => x.RecordedCompetitionsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DqStatus = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Participations_AspNetUsers_RecorderId",
                        column: x => x.RecorderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Participations_AspNetUsers_ShooterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserCompetition_RecordersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParticipationGroups_CompetitionId",
                table: "ParticipationGroups",
                column: "CompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_ParticipationGroups_ParentGroupId",
                table: "ParticipationGroups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participations_ParticipationGroupId",
                table: "Participations",
                column: "ParticipationGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Participations_RecorderId",
                table: "Participations",
                column: "RecorderId");
